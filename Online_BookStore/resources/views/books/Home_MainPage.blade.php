          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right scroll">
                 ...
                 <li ><a href="#partners">New Releases</a></li>
                 <li ><a href="#contact">Contact</a></li>
              </ul>
              <ul class="nav navbar-nav navbar-right " align="right">
                <li ><a href="loginfn">Login/Sign up</a></li>
              </ul>
            </div>
...
<h2 class="text-center wowload fadeInUp">Creative photographers of London</h2>  
  ...
  <div class="col-sm-6 wowload fadeInLeft">
    ...
    <p>Every Individual can upload his book and can read a book which wanted at that instant. He can enjoy the services</p>
